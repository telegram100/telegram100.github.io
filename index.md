...
* Если в мессенжере включено автокэширование и сохранение резервных копий в облаке, то есть дополнительный риск, что кто-то получит доступ к этой облачной копии 
