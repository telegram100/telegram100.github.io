...
* Cамые надёжные по этим трём параметрам:
  + simpleX chat
  + signal
  + element
  + session
    - без номера телефона, без email, только защищенное общение в децентрализованной сети
    - https://te-st.org/2024/10/14/session/ 
  + wire
  + cwtch
  + status.im
  + briar
...
* [Монокль](https://dept.one/memo/monocle/)
