...
* 2 способ: второй аккаунт Телеграм
  ...
  + Ещё один вариант, как не беспокоить знакомого:
    - настройить пересылку смс на email с помощью специального сервиса
...
* Если при входе в аккаунт Телеграм Вы выбираете опцию "Cинхронизировать контакты", то
  ...
  + даже после выхода из аккаунта Телеграм или после удаления приложения Телеграм, Ваши контакты будут доступны в аккаунте gmail (через какой-то телефон или компьютер)
