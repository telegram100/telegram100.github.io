...
## Дргуие мессенжеры Signal
* в Signal, как и в Телеграме, можно настроить автоудаляющиеся сообщения
...
* https://pwpush.com/
* Сам этот сервис тоже возможно использовать для конфиденциальной переписки, просто вместо позывного писать сообщение
  + это не удобно
...
* Россия начала покупать эти устройства не позже 2021 г.
* официально с 2021 года Россия больше их не покупает, но есть указания на то, что покупает в обход запретов, что имеет последние обновления и что сама производит подобные устройства
...
* производители: Cellebrite израильской фирмы, Аксиом и Мобильный криминалист российского производства, китайские фирмы
...
* шпионскую программу **Pegasus** находят на устройствах журналистов и активистов, живущих в Европе
  ...
  + в декабре 2021 года 86 правозащитных организаций направили  письмо с призывом к ЕС ввести глобальные санкции против NSO Group и попытаться запретить продажу, передачу, экспорт и импорт технологий наблюдения израильской компании
...
* система слежки NetBeholder позволяет силовикам отслеживать местонахождение любого российского пользователя популярных мессенджеров и детализирующей данные о всем контенте, которым он обменивается с другими пользователями
  + содержание _секретных_ чатов в Телеграм, WhatsApp, Signal, сотрудники спецслужб увидеть не могут
  ...
  + основной способ защиты — шифрование всего трафика, использовать _надежный_ VPN
