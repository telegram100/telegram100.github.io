...
## Мессенжеры
* В разных мессендерах (Телеграм, Signal, WhatsApp, ...) тоже есть секретные чаты, автоудаляющиеся сообщения
* Если в мессенжере включено автокэширование и сохранение резервных копий в облаке, то есть дополнительеный риск, что кто-то получит доступ к этой облучной копии 
* Информация из [этого видео](https://www.youtube.com/watch?v=maI_Ri2ucxo): мессенжер надёжный, если:
  ...
  + самые надёжные мессенжеры по этим трём параметрам: simpleX chat, signal, element, session, wire, cwtch, status.im, briar
