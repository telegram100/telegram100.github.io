...
* Информация из этого видео https://youtu.be/Ib4jFJrrgu8?si=ampMDm8RjRxlmiiS:
  ...
  + от этого не защищены новые устройства
  + не защищены запароленные устройства
  ...
  + официально с 2021 года Россия больше их не покупает, но есть указания на то, что покупает в обход запретов
