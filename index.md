...
* Информация [отсюда](https://www.youtube.com/watch?v=maI_Ri2ucxo): надёжность мессенжера зависит от:
  ...
  + самые надёжные мессенжеры: simpleX chat, signal, element, session, wire, cwtch, status.im, briar
...
* Система слежки NetBeholder позволяет силовикам отслеживать местонахождение любого российского пользователя популярных мессенджеров и детализирующей данные о всем контенте, которым он обменивается с другими пользователями
  ...
  + защита:
    ...
    - _надежный_  _проверенный_ VPN (провайдер будет видеть только то, что от вас исходит какой-то неназванный трафик в сторону VPN-сервера, и от него в вашу сторону ответный трафик - не смогут узнать, смотрели ли вы Ютуб, переписывались в Signal или смотрели сериал на «Кинопоиске»)
