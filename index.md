...
* [Видео о выборе мессенжера](https://www.youtube.com/watch?v=maI_Ri2ucxo)
  + мессенжер с сквозным шифрованием (end-to-end) защищён значительно лучше
    - при условии, что ключи подлинные, что сервер их не подменил
  + нужен сервер с открытым исходным кодом
  + важно, в какой юрисликции находится офис компании и в какой сервера, т.е. законы какой страны он вынежден соблюдать
    - если разработчики находятся в России, то силовики могут потребовать от них выдать данные
    - некоторые зарубежнгый спецслужбы сотрудничают с российскоми гласно или не гласно
