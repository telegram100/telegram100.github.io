...
## Мессенжеры
* в разных мессендерах (Signal, WhatsApp, ...) тоже есть секретные чаты, автоудаляющиеся сообщения
* отключайте автокэширование и сохранение резервных копий в облаке
* Информация [отсюда](https://www.youtube.com/watch?v=maI_Ri2ucxo): надёжность мессенжера зависит от:
  + сквозного шифрования (end-to-end)
    - при условии, что сервер не подменил ключи
  + открытого исходноно кода
  + юрисдикции, где находится офис компании и сервера, т.е. законы какой страны он вынужден соблюдать
    ...
    - важно следить за политическим контекстом - может произойти, что спецслужбы и государства договорятся
  + самые надёжные мессенжеры: simpleX chat, element, session, wire, cwtch, status.im, briar
  + оценивание безопасности других мессенжеров (из того же видео):
